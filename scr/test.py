from scr.roberta_prediction import RobertaInference

# 示例使用：
if __name__ == "__main__":
    model_inference = RobertaInference(config_path="../emotion_analysis/configs/config.yaml",
                                       model_path="../emotion_analysis/experiments/roberta/best_add.pt")
